import { defineComponent, useSSRContext, useAttrs, computed, toValue, inject, ref, provide, onMounted, watchEffect, cloneVNode, h, Fragment, onUnmounted, unref, getCurrentInstance, mergeProps } from 'vue';
import { _ as _export_sfc, d as useAppConfig, m as mergeConfig, g as get, o as omit, c as useNuxtApp } from './server.mjs';
...
const useFormGroup = (inputProps, config) => {
  ...
  return {
    ...
    size: computed(() => {
      ...
      return (_b = (_a2 = inputProps == null ? void 0 : inputProps.size) != null ? _a2 : formGroupSize) != null ? _b : (_a = config.default) == null ? void 0 : _a.size;
    }),
    color: computed(() => {
      var _a;
...
function o$2(e2) {
  ...
  if (e2 == null || e2.value == null)
    return null;
  let n = (l2 = e2.value.$el) != null ? l2 : e2.value;
...
function s(t2, e2) {
  ...
  return onMounted(() => {
    ...
    var u2;
    n.value || o$2(e2) && o$2(e2) instanceof HTMLButtonElement && !((u2 = o$2(e2)) != null && u2.hasAttribute("type")) && (n.value = "button");
  }), n;
}
...
function A({ visible: r2 = true, features: t2 = 0, ourProps: e2, theirProps: o2, ...i2 }) {
  var a;
  let n = j(o2, e2), l2 = Object.assign(i2, { props: n });
  if (r2 || t2 & 2 && n.static)
    return y(l2);
  if (t2 & 1) {
    let d2 = (a = n.unmount) == null || a ? 0 : 1;
    return u$2(d2, { [0]() {
      return null;
    }, [1]() {
...
function y({ props: r2, attrs: t2, slots: e2, slot: o2, name: i2 }) {
  var m, h$1;
  let { as: n, ...l2 } = T(r2, ["unmount", "static"]), a = (m = e2.default) == null ? void 0 : m.call(e2, o2), d2 = {};
  if (o2) {
    let u2 = false, c = [];
...
`));
  ...
  return h(n, Object.assign({}, l2, d2), { default: () => a });
}
function b(r2) {
...
function j(...r2) {
  ...
  for (let i2 of r2)
    for (let n in i2)
      n.startsWith("on") && typeof i2[n] == "function" ? (e2[n] != null || (e2[n] = []), e2[n].push(i2[n])) : t2[n] = i2[n];
...
let f$1 = defineComponent({ name: "Hidden", props: { as: { type: [Object, String], default: "div" }, features: { type: Number, default: 1 } }, setup(t2, { slots: n, attrs: i2 }) {
  return () => {
    var r2;
...
defineComponent({ name: "Description", props: { as: { type: [Object, String], default: "p" }, id: { type: String, default: null } }, setup(t2, { attrs: o2, slots: s2 }) {
  var n;
  let e2 = (n = t2.id) != null ? n : `headlessui-description-${I()}`, r2 = w();
  return onMounted(() => onUnmounted(r2.register(e2))), () => {
    let { name: i2 = "Description", slot: l2 = ref({}), props: d2 = {} } = r2, { ...c } = t2, f2 = { ...Object.entries(d2).reduce((a, [g, m]) => Object.assign(a, { [g]: unref(m) }), {}), id: e2 };
    return A({ ourProps: f2, theirProps: c, slot: l2.value, attrs: o2, slots: s2, name: i2 });
  };
} });

export { A, E, I, N, S, T, __nuxt_component_0 as _, useFormGroup as a, u$2 as b, u$1 as c, d, e, f$1 as f, inputMenu as g, o$1 as h, input as i, useId as j, k, l, o$2 as o, p, s, useUI as u };
//# sourceMappingURL=description-CiiiY9xm.mjs.map
