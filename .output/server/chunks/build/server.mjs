...
const _routes = [
  {
    name: "account",
    path: "/account",
    component: () => import('./account-BSonL6TM.mjs').then((m) => m.default || m)
  },
  {
    name: "asset",
    path: "/asset",
    component: () => import('./asset-CBZc2WEa.mjs').then((m) => m.default || m)
  },
  {
    name: "contacts",
    path: "/contacts",
    component: () => import('./contacts-C6n0ISoK.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-D4ZdfA1F.mjs').then((m) => m.default || m)
  },
  {
    name: "settings",
    path: "/settings",
    component: () => import('./settings-DTakpXkY.mjs').then((m) => m.default || m)
  },
  {
    name: "transactions",
    path: "/transactions",
    component: () => import('./transactions-CmfsfNJy.mjs').then((m) => m.default || m)
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-BwIhvTMx.mjs').then((r) => r["default"] || r.default || r));
...
let hcProps;
function extendProps(hcModNames) {
  hcProps = {};
...
function ComponentFactory(variant = "chart", dfltOptions = {}) {
  const props = {
    options: {
      type: Object,
    ...
    exporting: {
      type: Boolean,
      default: dfltOptions.exporting !== void 0 ? dfltOptions.exporting : false
    },
    update: {
      type: Array,
      default: () => ["options"]
  ...
  Object.entries(hcProps).forEach(([prop, fn]) => {
    if (props[prop] === void 0 && hcData[prop]) {
  ...
  return {
    render: () => h("div", {
      // TBD: In Vue3, we will import h and leave the function argument blank.
    ...
    methods: {
      constructChart(HC) {
        ...
        this.chart = chartConstructor(
          this.$refs[dfltOptions.ref || chartRef],
          // Highchart element
          this.optsCopy,
          (resp) => {
...
const plugin_IJZcPvBsSf = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const layouts = {
  default: () => import('./default-BNNFoFPg.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-qMmoYqto.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-yVFRxORC.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, appConfig as a, useState as b, useNuxtApp as c, useAppConfig as d, entry$1 as default, useRouter as e, navigateTo as f, get as g, useRuntimeConfig as h, asyncDataDefaults as i, createError as j, looseToNumber as l, mergeConfig as m, nuxtLinkDefaults as n, omit as o, resolveRouteObject as r, useHead as u };
